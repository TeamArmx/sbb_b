...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("السورس", "https://t.me/X_Error_404_X"),
                Button.url(
                    "الشرح",
                    "",
                ),
        ...
        buttons = [
            [
                Button.url(" مطور السورس", "https://t.me/X_Error_404_X"),
            ],
            [
