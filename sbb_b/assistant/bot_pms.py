...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("السورس", "https://t.me/USERNAME_NOT_REGISTED"),
                Button.url(
                    "الشرح",
                    "",
                ),
        ...
        buttons = [
            [
                Button.url(" مطور السورس", "https://t.me/USERNAME_NOT_REGISTED"),
            ],
            [
...
مطور السورس  @USERNAME_NOT_REGISTED""",
        buttons=[
