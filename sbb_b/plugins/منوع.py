...
R = [
    ...
    "**-** مطور السورس **⪼ [𐇮 𓂐 𓆩المبرمج زين𓆪 𖠛🇷🇺 ](t.me/wjj_u)   \n"
    "**-** مطوره السورس **⪼ [𐇮 المبرمجه ارمكس  ](t.me/dr_criss)   "
]
...
@sbb_b.ar_cmd(pattern="ارمكس$")
async def _(event):
    event = await edit_or_reply(event, "مطوره السورس")
    await event.edit("صحبت")
    await asyncio.sleep(0.3)
    await event.edit("-سورس ارمكس")
    await asyncio.sleep(0.2)
    await event.edit("يا شويه")
    await asyncio.sleep(0.5)
    await event.edit("- بطيخ🍉🍉 ")
    await asyncio.sleep(0.3)
    await event.edit("راقبو العظمه")
    await asyncio.sleep(0.3)
    await event.edit("-في صمت")
    await asyncio.sleep(0.3)
    await event.edit("جمدان المطوره ارمكس 🔥🔥🔥")
