...
async def iq(event):
     await edit_or_reply(event, "𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧDEAD CODEⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **⎈ ⦙  قائـمه اوامر الزغرفه :** \n⎈ ⦙  `.المواليد ` \n⎈ ⦙  `.اشهر مزغرفه` \n⎈ ⦙  `.الاختصارات` \n⎈ ⦙  `.البايو` \n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧDEAD CODEⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻",)
@sbb_b.on(admin_cmd(pattern="البايو(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "**⎈ ⦙  - 𝑩𝑰𝑶 𝑳𝑰𝑺𝑻 : **\n𓍹ⵧⵧⵧⵧⵧⵧDEAD CODEⵧⵧⵧⵧⵧⵧ𓍻\n **⎈ ⦙  قائـمه البايو :** \n⎈ ⦙  `.بايو1 ` \n⎈ ⦙  `.بايو2` \n⎈ ⦙  `.بايو3 ` \n⎈ ⦙  `.بايو4 ` \n⎈ ⦙  `.بايو5` \n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧDEAD CODEⵧⵧⵧⵧⵧⵧⵧⵧ𓍻")
@sbb_b.on(admin_cmd(pattern="الاختصارات(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "**⎈ ⦙  - 𝑺𝑯𝑶𝑹𝑻𝑪𝑼𝑻𝑺 : **\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧDEAD CODEⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **⎈ ⦙  قائـمه الاختصارات :** \n⎈ ⦙  `.اختصارات1 ` \n⎈ ⦙  `.اختصارات2` \n⎈ ⦙  `.اختصارات3 ` \n⎈ ⦙  `.اختصارات4 ` \n⎈ ⦙  `.اختصارات5` \n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧDEAD CODEⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻")
