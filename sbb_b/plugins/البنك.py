...
- مثال: .انشاء حساب الرافدين اوسورس ارمكس 
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def thief(message):
    ...
    await jepiq.send_file(
                message.chat_id,
                "https://telegra.ph/DAED-CODE-DEV-10-11",
...
async def bankar(message):
    ...
    if input == "ᥴ.ᖇ ᥉᥆υᖇᥴᥱ":
        bankn = "ََِِ𝗰.ًًٍٍ𝗥 ًًٍٍ𝗕ّّ𝗮ٍٍّّ𝗡ًًٍٍ𝗸"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "𝗰.ًًٍٍ𝗥 ًًٍٍ𝗕ّّ𝗮ٍٍّّ𝗡ًًٍٍ𝗸":
